...
template <typename T>
static typename FCoordinateFrame<T>::ConstReturnType MakeCoordinateFrame(const T& Object)
{
...
template <typename T>
static typename FCoordinateFrame<T>::ReturnType MakeCoordinateFrame(T& Object)
{
...
static typename FCoordinateFrameAux<T, P>::ConstReturnType MakeCoordinateFrame(const T& Object, const P& Parameter)
{
...
template <typename T, typename P>
static typename FCoordinateFrameAux<T, P>::ReturnType MakeCoordinateFrame(T& Object, const P& Parameter)
{
