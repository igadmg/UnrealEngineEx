...
#define LOCTEXT_NAMESPACE "PeekEditorCommands"



FName FPeekEditorCommands::NAME_ToolMode_Place("ToolMode_Place");



void FPeekEditorCommands::RegisterCommands()
{
	UI_COMMAND(PlaceMode, "Mode - Place", "", EUserInterfaceActionType::RadioButton, FInputChord());
	NameToCommandMap.Add(NAME_ToolMode_Place, PlaceMode);
	/*
